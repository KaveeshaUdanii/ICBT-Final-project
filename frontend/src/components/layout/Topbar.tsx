...
export function Topbar({ onMenuClick, title }: { onMenuClick: () => void; title: string }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-4 px-4 sm:px-8 py-4">
      <div className="flex items-center gap-3 min-w-0">
        <button
          onClick={onMenuClick}
          className="lg:hidden rounded-xl p-2 glass-panel"
      ...
      <div className="flex items-center gap-2.5 shrink-0">
        <button
          onClick={toggle}
          className="rounded-full p-2.5 glass-panel hover:border-indigo-400/40 transition"
        ...
        <div className="relative" ref={ref}>
          <button
            ...
            className="flex items-center gap-2 rounded-full glass-panel pl-1.5 pr-3 py-1.5 hover:border-indigo-400/40 transition"
          >
            <div className="h-7 w-7 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-xs font-semibold text-white">
